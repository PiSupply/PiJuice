...
Rload = 4.41 #[Ohm] Resistance of test load resistor connected to Vsys. 10Ohm/2W resistor is good example. Set to 0 if load resistor is not connected.
...
while 1:	
	...
	delTime = onTime if onOff else offTime
	if elapsed_time > adv_time + delTime:
		adv_time = adv_time + delTime
		onOff = not onOff
